  ...
  return (
    <div className="flex-col flex gap-10 px-5 md:px-10 justify-center">
      ...
      <div className="flex-col flex justify-center relative w-full">
        ...
        <div id="scroll-hor-con" ref={scrollHorizontalContainer} className="flex scroll-smooth flex-row flex-nowrap gap-5 overflow-x-scroll scrollbar-hide">
          <Card
            price={"14.5"}
            productName={"Stone SuCo - 600 ml"}
            img={
              "https://cdn.shopify.com/s/files/1/0811/0945/products/fire-on2.jpg?v=1671796215&width=1200"
            }
          />
          <Card
            price={"14.5"}
        ...
        <div className="hidden sm:block absolute w-full">
          <div className="absolute inset-y-0 left-2  -top-10 ">
            <button onClick={scrollLeft} className="absolute p-2 rounded-full hover:bg-gray-200 bg-white shadow-md">
              <CaretLeft size={32} color="#1a2c60" />
            </button>
          </div>
          <div className="absolute inset-y-0 right-14 -top-10">
            <button onClick={() => scrollRight()} className="absolute p-2 rounded-full hover:bg-gray-200 bg-white shadow-md ">
